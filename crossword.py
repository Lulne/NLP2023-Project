...
word_locations = [
    {"word": "cat", "start": (0, 0), "end": (2, 0), "orientation": "horizontal", "hint": "A small domesticated carnivorous mammal"},
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and not input_box.active:
            ...
            print("Selected word index:", selected_word_index, "Selected word:", selected_word, "Selected hint:", selected_hint)
